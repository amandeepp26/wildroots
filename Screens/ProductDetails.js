...
const images = [
    ...
    { src: require('../images/blueplant.jpg') },
    { src: require('../images/crotonplant.jpg') },
    { src: require('../images/blueplant.jpg') },
]
...
class ProductDetails extends Component {
    ...
    product_detail = (id) => {
        ...
        fetch(global.api, {
            ...
            .then((json) => {
                console.warn("detail",json[0].related)
                this.setState({ data: json[0], related: json[0].related, comments: json[0].comments, image:json[0].gallery.image0 })
                return json;
            }).catch((error) => {
                console.error(error);
            }).finally(() => {
            ...
            <View>
                ...
                <View>
                    ...
                    <View style={{ alignSelf: "center", width: Dimensions.get('window').width / 1.1, marginTop: 25 }}>
                        ...
                        <Text style={[styles.text, { marginTop: 5, fontSize: 16, lineHeight: 22 }]} numberOfLines={4}>
                            {/* <RenderHTML source={this.props.data.post_excerpt} /> */}
                            <View>
                            <HTMLView  value={this.props.data.post_excerpt} />
                            </View>
                ...
                <View>
                    ...
                    <View style={{ alignSelf: "center", width: Dimensions.get('window').width / 1.1, marginTop: 5 }}>
                        <Text style={[styles.text, { marginTop: 5, fontSize: 14, lineHeight: 22 }]}numberOfLines={4} >
                           <HTMLView value= {this.props.data.post_content} />
                        </Text>
                    </View>
                </View>
